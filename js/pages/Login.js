...
function LoginPage({ onLoggedIn }) {
  ...
  async function submit(e) {
    e.preventDefault();
    setError('');
    if (!username || !password) { setError('Enter your email and password.'); return; }
    setBusy(true);
    try {
      ...
      <div className="login-card slide-up">
        ...
        <form onSubmit={submit}>
          <div className="field">
            ...
            <input id="login-username" className="input" type="email" required value={username} onChange={(e) => setUsername(e.target.value)} placeholder="name@company.com" autoComplete="username" autoFocus />
          </div>
          <div className="field">
