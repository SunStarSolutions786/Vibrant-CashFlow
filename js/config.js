...
// Production uses Firebase on every browser host. Demo/local data is not
// included in the shipped application.
const FIREBASE_EXPORT_PAGE_SIZE = 500;
const FIREBASE_EXPORT_MAX_ROWS = 100000;
const MAPPING_MEMORY_MAX_ENTRIES = 1000;
...
// Default application settings, used until an Administrator saves settings.
